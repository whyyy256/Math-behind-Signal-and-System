...
可见，尽管连续系统的$s$平面与离散系统的$z$平面具有深刻而优美的对称关系，但并不能将连续系统的结论直接套用到离散系统中，例如，连续系统的相时延和群时延直接反应了响应相对激励的时延特性，而离散系统的相时延和群时延则需要在忽略暂态项的意义下，才能反应出响应相对激励的时延特性；连续系统的最小相位系统同时具有最小的相时延和群时延，而离散系统的最小相位系统仅具有最小的群时延，却未必具有最小的相时延。
